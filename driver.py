...
state_file_in = "state_dictionaries/states_nominal_deconv.pkl"
state_file_out = None

ae, data_train, loss_curves = ct.train( num_epoch = 0,
                                        state_file = state_file_in )

if state_file_out is not None: tc.save(ae.state_dict(), state_file_out)

cpl.show_examples(ae, std_background = 2, save_fig = False)
